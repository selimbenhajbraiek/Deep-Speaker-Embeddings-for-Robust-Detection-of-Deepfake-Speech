...
train_file = r'C:\Users\R I B\Desktop\Study\Project Laboratory 2\Deep-Speaker-Embeddings-for-Robust-Detection-of-Deepfake-Speech\data\meta.csv'
train_df = pd.read_csv(train_file, low_memory=False)

# Load the testing data
test_file = r'C:\Users\R I B\Desktop\Study\Project Laboratory 2\Deep-Speaker-Embeddings-for-Robust-Detection-of-Deepfake-Speech\data\meta.csv'
test_df = pd.read_csv(test_file, low_memory=False)

# Separate features and target in training data
X_train = train_df.drop(['file','speaker','label'], axis=1)  # Features
y_train = train_df['label']  # Target

# Separate features and target in testing data
X_test = test_df.drop(['file','speaker','label'], axis=1)  # Features
...
report_file = r'C:\Users\R I B\Desktop\Study\Project Laboratory 2\Deep-Speaker-Embeddings-for-Robust-Detection-of-Deepfake-Speech\data\LRclassification_report_meta.txt'
